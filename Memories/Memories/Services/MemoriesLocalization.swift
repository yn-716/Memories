...
enum MemoriesLocalization {
    ...
    private static let ja: [String: String] = [
        ...
        "calendar.caption": "キャプション",
        "calendar.captionCounter": "%d / %d文字",
        ...
        "calendar.widgetHelpLock": "ロック画面Widgetでは、今日の日付、登録状態、短いキャプションを確認できます。",
    ...
    private static let en: [String: String] = [
        ...
        "calendar.captionCounter": "%d / %d chars",
        ...
        "calendar.widgetHelpLock": "Lock Screen widgets show today's date, registration status, and a short caption.",
