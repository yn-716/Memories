...
enum MemoriesLocalization {
    ...
    private static let ja: [String: String] = [
        ...
        "settings.suggestPlaceFromPhotoLocation": "写真の位置情報から場所を提案",
        "settings.suggestPlaceFromPhotoLocationDescription": "選択した写真に位置情報が含まれる場合、場所欄の初期値に使用します。地名変換のために座標を利用する場合があります。",
        "settings.plan": "プラン",
        "settings.free": "無料",
    ...
    private static let en: [String: String] = [
        ...
        "settings.suggestPlaceFromPhotoLocation": "Suggest place from photo location",
        "settings.suggestPlaceFromPhotoLocationDescription": "When a selected photo includes location data, it can be used to suggest the initial place text. Coordinates may be used for place name lookup.",
        "settings.plan": "Plan",
        "settings.free": "Free",
